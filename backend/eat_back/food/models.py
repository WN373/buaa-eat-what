...
class FoodInfo(models.Model):
    ...
    region = models.ForeignKey('RegionInfo', on_delete=models.CASCADE, verbose_name='地区', blank=True)
    counter = models.ForeignKey('CounterInfo', on_delete=models.CASCADE, verbose_name='柜台', blank=True)
