...
class MulClassShowCounter(ScrollArea):
    ...
    def __init__(self, restList: list, title, subtitle, parentHallName):  # restList 待展示的食堂列表
        ...
        self.lst.append(self.addCard('新北一层', ['resource/images/find.png', 'resource/images/star_yes.png',
                                                  'resource/images/delete.png'], self))
        self.lst.append(self.addCard('合一三层', ['resource/images/find.png', 'resource/images/star_yes.png',
                                                  'resource/images/delete.png'], self))
        self.lst.append(self.addCard('美食苑', ['resource/images/find.png', 'resource/images/star_yes.png',
                                                'resource/images/delete.png'], self))
        self.lst.append(self.addCard('新北地下', ['resource/images/find.png', 'resource/images/star_yes.png',
                                                  'resource/images/delete.png'], self))
